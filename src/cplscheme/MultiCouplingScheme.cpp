...
MultiCouplingScheme::MultiCouplingScheme(
    ...
    : BaseCouplingScheme(maxTime, maxTimeWindows, timeWindowSize, validDigits, localParticipant, maxIterations, minIterations, Implicit, dtMethod, extrapolationOrder),
