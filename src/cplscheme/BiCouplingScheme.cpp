...
BiCouplingScheme::BiCouplingScheme(
    ...
    : BaseCouplingScheme(maxTime, maxTimeWindows, timeWindowSize, validDigits, localParticipant, maxIterations, cplMode, dtMethod, extrapolationOrder, experimentalAPI),
      _m2n(std::move(m2n)),
